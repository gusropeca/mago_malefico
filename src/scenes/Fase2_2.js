...
export class Fase2_2 extends CenaBase {
    constructor() {
    super('Fase2_2');
  }
    ...
    preload() {
        ...
        super.preload();
        this.load.image('Castelo2', 'assets/InteriorCastelo2.png');
  ...
  this.sound.stopByKey('TrilhaSonoraFase2');
  ...
  this.cameras.main.once('camerafadeoutcomplete', () => {
    ...
    this.scene.start('Fase2_3', { // Pode ser Fase1_2 ou a próxima fase real
