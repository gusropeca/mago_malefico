export class Fase2_3 extends Phaser.Scene{
     constructor() {
        super('Fase2_3');
    }

        preload() {
            this.load.image('CasteloRei', 'assets/InteriorCastelo3.png');
        ...
        create() {
            ...
            this.background = this.add.tileSprite(400, 300, 800, 600, 'CasteloRei');
