...
export class FaseTutorial extends CenaBase {
  constructor() {
    super('FaseTutorial');
  }
  ...
  preload() {
    super.preload();
    this.load.image('tutorial1', 'assets/PlacaTutorial1.png');
    this.load.image('tutorial2', 'assets/PlacaTutorial2.png');
    ...
    this.load.audio('TrilhaSonoraFase1', 'assets/music/MusicaFase1.mp3');
  ...
  create() {
    ...
    const placa1 = this.add.image(400, 100, 'tutorial1');
    const placa2 = this.add.image(700, 100, 'tutorial2');
    placa1.setScale(1.2);
    placa2.setScale(1.2);

    this.music = this.sound.add('TrilhaSonoraFase1', { 
            loop: true,
            volume: 0.5
        });
    this.music.play();
